...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    ...
    class App {
      ...
      initPasses() {
        // Postprocessing is disabled for Next.js stability.
        // The generated React Bits setup can crash inside EffectComposer.addPass
        // with: "Cannot read properties of null (reading 'alpha')".
        // We render the scene directly with THREE.WebGLRenderer instead.
        this.composer = null;
      }

      loadAssets() {
        // No external postprocessing assets are needed because SMAA/Bloom are disabled.
